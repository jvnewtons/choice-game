...
while jogo == 0:
    ...
    print("aproxima cada vez mais de Newton e seus tentáculos atacam, porém, em um piscar de olhos, seu salvador se levanta e se")
    ...
    print("criatura fica mais perto de acertar seus ataques, então um tentáculo pega de raspão em Newton, depois mais outro, cada")
    ...
    if (escolha3 == 0):
        ...
        print("a oportunidade perfeita para Newton, e ele não perde tempo, sua lâmina dança no ar e o corpo da criatura é cor-")
        ...
        if(EscolhaAlternativa == 1):
            ...
            print("Você escuta Dália gritar por você. O demônio com 3 tentáculos ocupados rapidamente é subjulgado por Dália")
